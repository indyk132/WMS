                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="flex justify-between items-center w-full">
                                                    <span className="text-xs font-bold font-mono text-zinc-800 flex items-center gap-1">
                                                        {zone.id}
                                                        {zone.isLocked && <span className="text-[10px] text-red-650" title="ZABLOKOWANA">🔒</span>}
                                                    </span>
                                    ...
                                    {zones.filter(z => z.block === 'HAZMAT').map(zone => {
                                        ...
                                        return (
                                            <button
                                                key={zone.id}
                                                onClick={() => handleSelectZone(zone.id)}
                                                className={`p-2.5 rounded-lg flex flex-col justify-between border cursor-pointer relative transition-all overflow-hidden bg-white hover:bg-zinc-50 border-zinc-200 shadow-sm min-h-[76px] ${
                                                    isSelected
                                                        ? 'ring-2 ring-zinc-950 scale-[1.03] shadow-md z-10 border-transparent'
                                                        : ''
                                                }`}
                                                            ...
                                                            <div key={slotNum} className="relative group">
                                                                {isOccupied ? (
                                                                    <>
                                                                        ...
                                                                        >
                                                                            <div className="flex justify-between items-center text-[8px] opacity-75 leading-none w-full relative z-10">
                                                                                ...
                                                                                <span className="font-extrabold bg-white/15 px-1 py-0.5 rounded text-[8.5px] tracking-wide font-sans">{prod.quantity} szt.</span>
                                                                            </div>
                                                                        ...
                                                                        <div className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-44 -translate-x-1/2 scale-95 rounded-md bg-zinc-950 border border-zinc-800 p-2 text-center text-[10px] font-medium text-zinc-350 shadow-xl opacity-0 transition-all duration-150 group-hover:opacity-100 group-hover:scale-100 leading-relaxed">
                                                                            ...
                                                                            <div className="text-[9px] text-zinc-400 font-sans mt-0.5">Ilość: <span className="font-bold text-white">{prod.quantity} szt.</span></div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        className={`p-2 rounded text-[9px] border border-zinc-800 border-dashed bg-zinc-950/40 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-900/60 hover:border-zinc-600 cursor-pointer flex flex-col justify-center items-center text-center font-mono leading-none h-[64px] transition-all hover:scale-[1.02] ${
                                                                            selectedSlot?.rack === rackNum && selectedSlot?.level === levelNum && selectedSlot?.slot === slotNum
